...
<!--        <el-input v-model="form.score" placeholder="请借书积分"></el-input>-->
        <el-input-number v-model="form.score" @change="handleChange" :min="10" :max="30" label="所需积分"></el-input-number>
      </el-form-item>
      <br>
